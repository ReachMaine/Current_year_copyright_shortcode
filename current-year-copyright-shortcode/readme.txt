...
[current_year_with_copyright] - This shortcode displays the current year with the copyright symbol to its left. Assuming the current year to be 2015 the shorcode will display "© 2015" (without quotes) wherever it is used.

[current_year_with_copyright_and_title] - This shortcode displays the current year with the copyright symbol and site title to its left. Assuming the current year to be 2015 the shorcode will display "Site Title © 2015" (without quotes) wherever it is used.
